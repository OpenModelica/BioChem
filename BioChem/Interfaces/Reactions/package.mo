...
package Reactions "Partial models, extended by models in the package BioChem.Reactions"
 ...
 Note that all partial reaction models include definitions of stoichiometric coefficients (nS1, nS2, ... and nP1, nP2, ...). These coefficients correspond to the stoichiometry attribute in SBML and should not appear in the reaction rate formula in the reaction.<img src=\"modelica://BioChem/DocumentationFiles/Reactions.png\" alt=\"\"/><br><i>Fig. 1 Some of the reactions</i>
    </body>
