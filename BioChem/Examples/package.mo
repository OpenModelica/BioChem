...
<h1>InsulinSignaling</h1>
 ...
 ", revisions=""), Diagram(coordinateSystem(extent={{-100,100},{100,-100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Ellipse(visible=true, lineColor={85,170,255}, fillColor={0,0,255}, fillPattern=FillPattern.Sphere, extent={{-100.43,-91.42},{100.02,19.94}}),Line(visible=true, points={{0.0,110.0},{0.0,-34.05},{25.0,-52.36}}, color={170,0,0})}));
    ...
    Substances.Substance irInt(c.start=1/10000000000000.0) "Internal IR" annotation(Placement(visible=true, transformation(origin={-70,-50}, extent={{-10,-10},{10,10}}, rotation=0)));
    Substances.Substance irPIntIns(c.start=0) "Internal phosphorylated insulin receptor, one insulin" annotation(Placement(visible=true, transformation(origin={-34,-10}, extent={{-10,-10},{10,10}}, rotation=0)));
    Substances.Substance irPInt2Ins(c.start=0) "Internal phosphorylated insulin receptor, two insulin bound" annotation(Placement(visible=true, transformation(origin={-4,-10}, extent={{-10,-10},{10,10}}, rotation=0)));
    Reactions.MassAction.Irreversible.UniUni.Uui uui2(k1=0.461/60) annotation(Placement(visible=true, transformation(origin={-38,-50}, extent={{-10,-10},{10,10}}, rotation=180)));
    Reactions.MassAction.Reversible.BiUni.Bur bur2(k1=60000000/60, k2=100*0.2/60) annotation(Placement(visible=true, transformation(origin={30,50}, extent={{-10,-10},{10,10}}, rotation=0)));
    Reactions.MassAction.Reversible.BiUni.Bur bur1(k2=0.2/60, k1=60000000/60) annotation(Placement(visible=true, transformation(origin={-54,50}, extent={{-10,-10},{10,10}}, rotation=0)));
    Reactions.MassAction.Reversible.UniUni.Uur uur5(k2=0.003/60, k1=0.003/9/60) annotation(Placement(visible=true, transformation(origin={-70,-10}, extent={{-10,-10},{10,10}}, rotation=270)));
    Reactions.MassAction.Reversible.UniUni.Uur uur3(k1=0.00021/60, k2=0.0021/60) annotation(Placement(visible=true, transformation(origin={20,10}, extent={{-10,-10},{10,10}}, rotation=0)));
    Reactions.MassAction.Irreversible.UniUni.Uui uui1(k1=0.461/60) annotation(Placement(visible=true, transformation(origin={-51.5948,-30}, extent={{-10,-10},{10,10}}, rotation=180)));
    Reactions.MassAction.Irreversible.UniUni.Uui uui3(k1=0.2/60) annotation(Placement(visible=true, transformation(origin={-50,20}, extent={{-10,-10},{10,10}}, rotation=180)));
    Substances.Substance Insulin(c.start=1/10000000) "Insulin" annotation(Placement(visible=true, transformation(origin={-70,70}, extent={{-10,-10},{10,10}}, rotation=0)));
    Reactions.MassAction.Reversible.UniUni.Uur uur2(k1=0.00021/60, k2=0.0021/60) annotation(Placement(visible=true, transformation(origin={-17.5,10}, extent={{-10,-10},{10,10}}, rotation=0)));
    Substances.Substance irMembIns(c.start=0) "Insulin receptor at plasma membrane, one insulin bound" annotation(Placement(visible=true, transformation(origin={-30,30}, extent={{-10,-10},{10,10}}, rotation=0)));
    Substances.Substance irMemb(c.start=9/10000000000000.0) annotation(Placement(visible=true, transformation(origin={-70,30}, extent={{-10,-10},{10,10}}, rotation=0)));
    Substances.Substance irPMemb2Ins(c.start=0) "Phosphorylated insulin receptor at plasma membrane, two insulin bound" annotation(Placement(visible=true, transformation(origin={50,30}, extent={{-10,-10},{10,10}}, rotation=0)));
    Interfaces.Nodes.SubstanceConnector sInsulin "Connector for insulin" annotation(Placement(visible=true, transformation(origin={0.0,100.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=180), iconTransformation(origin={-0.0,115.0}, extent={{-15.0,-15.0},{15.0,15.0}}, rotation=180)));
  equation
    connect(sInsulin,Insulin.n1) annotation(Line(visible=true, points={{0.0,100.0},{0.0,70.04},{-70.0,70.0}}, smooth=Smooth.Bezier));
    connect(irPInt2Ins.n1,uur3.s1) annotation(Line(visible=true, points={{-4,-10},{-4.267,10.24},{8.75,10}}, smooth=Smooth.Bezier));
    connect(uur5.p1,irInt.n1) annotation(Line(visible=true, points={{-70,-21.25},{-70,-50}}));
    connect(bur2.s2,irPMembIns.n1) annotation(Line(visible=true, points={{18.75,45},{10,46.2},{10,30}}, smooth=Smooth.Bezier));
    connect(uui3.s1,irPIntIns.n1) annotation(Line(visible=true, points={{-38.75,20},{-37.5,18.75},{-34,11.25},{-34,-10}}, smooth=Smooth.Bezier));
    connect(uui1.p1,irInt.n1) annotation(Line(visible=true, points={{-62.8448,-30},{-70.27,-29.87},{-70,-50}}, smooth=Smooth.Bezier));
    connect(uui1.s1,irPIntIns.n1) annotation(Line(visible=true, points={{-40.3448,-30},{-34,-30},{-34,-10}}, smooth=Smooth.Bezier));
    connect(uui2.s1,irPInt2Ins.n1) annotation(Line(visible=true, points={{-26.75,-50},{-4.07,-50.04},{-4,-10}}, smooth=Smooth.Bezier));
    connect(uui.p1,irPMembIns.n1) annotation(Line(visible=true, points={{1.25,30},{10,30}}));
    connect(irInt.n1,uui2.p1) annotation(Line(visible=true, points={{-70,-50},{-49.25,-50}}));
    connect(Insulin.n1,bur1.s1) annotation(Line(visible=true, points={{-70,70},{-70.07,54.05},{-65.25,55}}, smooth=Smooth.Bezier));
    connect(Insulin.n1,bur2.s1) annotation(Line(visible=true, points={{-70,70},{-30,69.99},{-7.5,54.62},{18.75,55}}, smooth=Smooth.Bezier));
    connect(uur2.p1,irPMembIns.n1) annotation(Line(visible=true, points={{-6.25,10},{0,10},{10,30}}, smooth=Smooth.Bezier));
    connect(irPIntIns.n1,uur2.s1) annotation(Line(visible=true, points={{-34,-10},{-34,10},{-28.75,10}}, smooth=Smooth.Bezier));
    connect(irMembIns.n1,uui.s1) annotation(Line(visible=true, points={{-30,30},{-21.25,30}}));
    connect(bur1.p1,irMembIns.n1) annotation(Line(visible=true, points={{-42.75,50},{-30,50},{-30,30}}, smooth=Smooth.Bezier));
    connect(irMemb.n1,uui3.p1) annotation(Line(visible=true, points={{-70,30},{-69.7,20.2},{-61.25,20}}, smooth=Smooth.Bezier));
    connect(irMemb.n1,bur1.s2) annotation(Line(visible=true, points={{-70,30},{-70.07,46.2},{-65.25,45}}, smooth=Smooth.Bezier));
    connect(uur5.s1,irMemb.n1) annotation(Line(visible=true, points={{-70,1.25},{-70,30}}));
    connect(bur2.p1,irPMemb2Ins.n1) annotation(Line(visible=true, points={{41.25,50},{50.01,50},{50,30}}, smooth=Smooth.Bezier));
    connect(uur3.p1,irPMemb2Ins.n1) annotation(Line(visible=true, points={{31.25,10},{50,10},{50,30}}, smooth=Smooth.Bezier));
...
<h1>Glycolysis</h1>
 ...
 ", revisions=""), Icon(coordinateSystem(extent={{-100,100},{100,-100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Line(visible=true, points={{0,100},{0,25},{-25,0},{0,-25},{0,-75},{-25,-100}}),Line(visible=true, points={{0,25},{25,0},{-25,0}}),Line(visible=true, points={{0,-75},{25,-100}})}), Diagram(coordinateSystem(extent={{-105,148.5},{105,-148.5}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})));
    ...
    Reactions.MassAction.Irreversible.UniUni.Uui uui4 annotation(Placement(visible=true, transformation(origin={1.19682e-13,-123.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-90)));
    Reactions.MassAction.Reversible.UniUni.Uur uur2 annotation(Placement(visible=true, transformation(origin={1.1291e-13,-63.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
    Substances.Substance G13BP(c.start=0) "Glycerate-1,3-bisphosphate" annotation(Placement(visible=true, transformation(origin={1.16462e-13,-18.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
    Reactions.MassAction.Reversible.UniUni.Uur uur(k1=1) annotation(Placement(visible=true, transformation(origin={1.13798e-13,93.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-90)));
    Reactions.MassAction.Reversible.UniUni.Uur uur1 annotation(Placement(visible=true, transformation(origin={1.17351e-13,18.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=0)));
    Reactions.MassAction.Irreversible.UniBi.Ubi ubi annotation(Placement(visible=true, transformation(origin={1.60982e-14,33.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=270)));
    Reactions.MassAction.Irreversible.UniUni.Uui uui3 annotation(Placement(visible=true, transformation(origin={-6.3094e-13,-93.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=270)));
    Substances.Substance G2P1(c.start=0) "Glycerate-2-phosphate" annotation(Placement(visible=true, transformation(origin={1.03362e-13,-78.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-630)));
    Reactions.MassAction.Irreversible.UniUni.Uui uui2 annotation(Placement(visible=true, transformation(origin={1.14242e-13,-33.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-90)));
    Substances.Substance GA3P(c.start=0) "Glycerate-3-phosphate" annotation(Placement(visible=true, transformation(origin={1.06248e-13,-48.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
    Reactions.MassAction.Irreversible.UniUni.Uui uui5(k1=1) annotation(Placement(visible=true, transformation(origin={1.03287e-11,123.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-90)));
    Reactions.MassAction.Irreversible.UniUni.Uui uui annotation(Placement(visible=true, transformation(origin={1.91513e-13,63.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-90)));
    Substances.Substance Pyruvate(c.start=0) annotation(Placement(visible=true, transformation(origin={1.19571e-13,-138.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-360)));
    Substances.Substance Glucose(c.start=1) "Glucose" annotation(Placement(visible=true, transformation(origin={3.32706e-16,139.222}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
    Substances.Substance G6P(c.start=0) "Glucose-6-phosphate" annotation(Placement(visible=true, transformation(origin={1.13798e-13,108.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
    Substances.Substance F6P(c.start=0) "Fructose-6-phosphate" annotation(Placement(visible=true, transformation(origin={2.39286e-12,78.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-630)));
    Substances.Substance F16BP(c.start=0) "Fructose-1,6-bisphosphate" annotation(Placement(visible=true, transformation(origin={1.13354e-13,48.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=-270)));
    Substances.Substance G3P(c.start=0) "Glyceraldehyde-3-phosphate" annotation(Placement(visible=true, transformation(origin={-15,18.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=0)));
    Substances.Substance DHAP(c.start=0) "Dihydroxyacetone phosphate" annotation(Placement(visible=true, transformation(origin={15,18.75}, extent={{-7.5,-7.5},{7.5,7.5}}, rotation=0)));
    BioChem.Interfaces.Nodes.SubstanceConnector sGlucose annotation(Placement(visible=true, transformation(origin={0.0,147.5}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=180), iconTransformation(origin={0.0,115.0}, extent={{-15.0,-15.0},{15.0,15.0}}, rotation=180)));
    Interfaces.Nodes.SubstanceConnector sPyruvate annotation(Placement(visible=true, transformation(origin={-22.5,-147.5}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0), iconTransformation(origin={-27.5,-112.5}, extent={{-12.5,-12.5},{12.5,12.5}}, rotation=0)));
    Interfaces.Nodes.SubstanceConnector sPyruvate4 annotation(Placement(visible=true, transformation(origin={22.5,-147.5}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0), iconTransformation(origin={27.5,-112.5}, extent={{-12.5,-12.5},{12.5,12.5}}, rotation=0)));
  equation
    connect(Pyruvate.n1,sPyruvate4) annotation(Line(visible=true, points={{0.0,-138.75},{22.5,-139.4},{22.5,-147.5}}, smooth=Smooth.Bezier));
    connect(sPyruvate,Pyruvate.n1) annotation(Line(visible=true, points={{-22.5,-147.5},{-22.5,-138.8},{0.0,-138.75}}, smooth=Smooth.Bezier));
    connect(sGlucose,Glucose.n1) annotation(Line(visible=true, points={{0.0,147.5},{0.0,139.222}}));
    connect(GA3P.n1,uur2.p1) annotation(Line(visible=true, points={{1.06248e-13,-48.75},{1.12893e-13,-55.3125}}));
    connect(uur2.s1,G2P1.n1) annotation(Line(visible=true, points={{1.12893e-13,-72.1875},{1.03362e-13,-78.75}}));
    connect(uui3.p1,PEP1.n1) annotation(Line(visible=true, points={{-6.30923e-13,-102.188},{2.96307e-12,-108.75}}));
    connect(uui1.p1,G13BP.n1) annotation(Line(visible=true, points={{1.83981e-13,-12.1875},{1.16462e-13,-18.75}}));
    connect(uui2.p1,GA3P.n1) annotation(Line(visible=true, points={{1.14259e-13,-42.1875},{1.06248e-13,-48.75}}));
    connect(G2P1.n1,uui3.s1) annotation(Line(visible=true, points={{1.03362e-13,-78.75},{-6.30957e-13,-85.3125}}));
    connect(PEP1.n1,uui4.s1) annotation(Line(visible=true, points={{2.96307e-12,-108.75},{1.19665e-13,-115.312}}));
    connect(G13BP.n1,uui2.s1) annotation(Line(visible=true, points={{1.16462e-13,-18.75},{1.14225e-13,-25.3125}}));
    connect(uui4.p1,Pyruvate.n1) annotation(Line(visible=true, points={{1.19699e-13,-132.188},{1.19571e-13,-138.75}}));
    connect(Glucose.n1,uui5.s1) annotation(Line(visible=true, points={{3.32706e-16,139.222},{1.03287e-11,132.188}}));
    connect(uui5.p1,G6P.n1) annotation(Line(visible=true, points={{1.03287e-11,115.312},{1.13798e-13,108.75}}));
    connect(G6P.n1,uur.s1) annotation(Line(visible=true, points={{1.13798e-13,108.75},{1.13815e-13,102.188}}));
    connect(F6P.n1,uui.s1) annotation(Line(visible=true, points={{2.39286e-12,78.75},{1.91496e-13,72.1875}}));
    connect(uur.p1,F6P.n1) annotation(Line(visible=true, points={{1.13815e-13,85.3125},{2.39286e-12,78.75}}));
    connect(F16BP.n1,ubi.s1) annotation(Line(visible=true, points={{1.13354e-13,48.75},{1.60815e-14,42.1875}}));
    connect(uui.p1,F16BP.n1) annotation(Line(visible=true, points={{1.9153e-13,55.3125},{1.13354e-13,48.75}}));
    connect(ubi.p2,G3P.n1) annotation(Line(visible=true, points={{-3.75,25.3125},{-15,26.25},{-15,18.75}}, smooth=Smooth.Bezier));
    connect(G3P.n1,uui1.s1) annotation(Line(visible=true, points={{-15,18.75},{-7.5,11.25},{1.138e-13,7.719},{1.83947e-13,4.6875}}, smooth=Smooth.Bezier));
    connect(uur1.s1,G3P.n1) annotation(Line(visible=true, points={{-8.4375,18.75},{-15,18.75}}));
    connect(ubi.p1,DHAP.n1) annotation(Line(visible=true, points={{3.75,25.3125},{15,26.25},{15,18.75}}, smooth=Smooth.Bezier));
    connect(DHAP.n1,uur1.p1) annotation(Line(visible=true, points={{15,18.75},{8.4375,18.75}}));
  end Glycolysis;
...
<img src=\"modelica://BioChem/Resources/Images/Cell.png\" alt=\"Fig1: Simulation results\">
      ...
      BioChem.Examples.GMO.cell.C_ C(c(start=0.01)) "Cyclin" annotation(Placement(visible=true, transformation(origin={80.0,0.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-270)));
      BioChem.Examples.GMO.cell.M_ M(c(start=0.01)) "CDC-2 Kinase" annotation(Placement(visible=true, transformation(origin={-70.0,70.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
      BioChem.Examples.GMO.cell.X_ X(c(start=0.01)) "Cyclin Protease" annotation(Placement(visible=true, transformation(origin={50.0,-30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      Real V1 "V1";
      Real V3 "V3";
      parameter Real VM1=3 "VM1";
      parameter Real VM3=1 "VM3";
      parameter Real Kc=0.5 "Kc";
      BioChem.Substances.AmbientSubstance ambientSubstance annotation(Placement(visible=true, transformation(origin={-10.0,30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
      BioChem.Examples.GMO.cell.reaction1_ reaction1 "creation of cyclin" annotation(Placement(visible=true, transformation(origin={50.0,40.0}, extent={{-10.0,10.0},{10.0,-10.0}}, rotation=0)));
      BioChem.Examples.GMO.cell.reaction2_ reaction2 "default degradation of cyclin" annotation(Placement(visible=true, transformation(origin={30.0,-60.0}, extent={{-10.0,10.0},{10.0,-10.0}}, rotation=180)));
      BioChem.Examples.GMO.cell.reaction3_ reaction3 "cdc2 kinase triggered degration of cyclin" annotation(Placement(visible=true, transformation(origin={50.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
      BioChem.Examples.GMO.cell.reaction4_ reaction4(V1=V1) "activation of cdc2 kinase" annotation(Placement(visible=true, transformation(origin={-70.0,40.0}, extent={{10.0,-10.0},{-10.0,10.0}}, rotation=270)));
      BioChem.Examples.GMO.cell.reaction5_ reaction5 "deactivation of cdc2 kinase" annotation(Placement(visible=true, transformation(origin={-30.0,70.0}, extent={{-10.0,10.0},{10.0,-10.0}}, rotation=0)));
      BioChem.Examples.GMO.cell.reaction6_ reaction6(V3=V3) "activation of cyclin protease" annotation(Placement(visible=true, transformation(origin={10.0,-37.8911}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      BioChem.Examples.GMO.cell.reaction7_ reaction7 "deactivation of cyclin protease" annotation(Placement(visible=true, transformation(origin={20.0,-10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
    equation
      connect(X.n1,reaction7.s1) annotation(Line(visible=true, origin={43.75,-16.6667}, points={{6.25,-13.3333},{6.25,6.6667},{-12.5,6.6667}}, smooth=Smooth.Bezier));
      connect(ambientSubstance.n1,reaction7.p1) annotation(Line(visible=true, origin={-3.75,3.3333}, points={{-6.25,26.6667},{-6.25,-13.3333},{12.5,-13.3333}}, smooth=Smooth.Bezier));
      connect(X.n1,reaction6.p1) annotation(Line(visible=true, origin={30.5633,-33.9455}, points={{19.4367,3.9455},{-5.0617,3.9455},{-5.0617,-3.9455},{-9.3133,-3.9455}}, smooth=Smooth.Bezier));
      connect(X.n1,reaction3.m1) annotation(Line(visible=true, origin={50.0,-14.5}, points={{0.0,-15.5},{0.0,15.5}}, smooth=Smooth.Bezier));
      connect(ambientSubstance.n1,reaction6.s1) annotation(Line(visible=true, origin={-7.0833,-15.2607}, points={{-2.9167,45.2607},{-2.9167,-22.6304},{5.8333,-22.6304}}, smooth=Smooth.Bezier));
      connect(M.n1,reaction4.p1) annotation(Line(visible=true, origin={-70.0,60.625}, points={{0.0,9.375},{0.0,-9.375}}, smooth=Smooth.Bezier));
      connect(ambientSubstance.n1,reaction4.s1) annotation(Line(visible=true, origin={-39.2,27.5494}, points={{29.2,2.4506},{16.2,2.4506},{16.2,-3.0509},{-30.8,-3.0509},{-30.8,1.2006}}, smooth=Smooth.Bezier));
      connect(M.n1,reaction5.s1) annotation(Line(visible=true, origin={-55.625,70.0}, points={{-14.375,0.0},{14.375,0.0}}, smooth=Smooth.Bezier));
      connect(ambientSubstance.n1,reaction5.p1) annotation(Line(visible=true, origin={-12.9167,56.6667}, points={{2.9167,-26.6667},{2.9167,13.3333},{-5.8333,13.3333}}, smooth=Smooth.Bezier));
      connect(C.n1,reaction2.s1) annotation(Line(visible=true, origin={67.0833,-40.0}, points={{12.9167,40.0},{12.9167,-20.0},{-25.8333,-20.0}}, smooth=Smooth.Bezier));
      connect(ambientSubstance.n1,reaction2.p1) annotation(Line(visible=true, origin={-50.4167,-20.9454}, points={{40.4167,50.9454},{-9.5833,-30.588},{69.1667,-39.0546}}, smooth=Smooth.Bezier));
      connect(C.n1,reaction1.p1) annotation(Line(visible=true, origin={73.75,26.6667}, points={{6.25,-26.6667},{6.25,13.3333},{-12.5,13.3333}}, smooth=Smooth.Bezier));
      connect(ambientSubstance.n1,reaction1.s1) annotation(Line(visible=true, origin={24.4367,35.0}, points={{-34.4367,-5.0},{10.0617,-5.0},{10.0617,5.0},{14.3133,5.0}}, smooth=Smooth.Bezier));
      connect(ambientSubstance.n1,reaction3.p1) annotation(Line(visible=true, origin={24.4367,20.0}, points={{-34.4367,10.0},{10.0617,10.0},{10.0617,-10.0},{14.3133,-10.0}}, smooth=Smooth.Bezier));
      connect(C.n1,reaction3.s1) annotation(Line(visible=true, origin={68.0633,5.0}, points={{11.9367,-5.0},{-2.5617,-5.0},{-2.5617,5.0},{-6.8133,5.0}}, smooth=Smooth.Bezier));
      V1=C.c*VM1*(C.c + Kc)^(-1);
      V3=M.c*VM3;
    end cell;
...
<img src=\"modelica://BioChem/Resources/Images/Cell2.png\" alt=\"Fig1: Simulation results\">
      ...
      inner Real cell_V=V "Variable used to make the compartment volume accessible for inner components. Do not edit.";
      CellDivison.cell.EmptySet_ EmptySet(c(start=0)) annotation(Placement(visible=true, transformation(origin={10.0,20.0}, extent={{-10.0,10.0},{10.0,-10.0}}, rotation=0)));
      CellDivison.cell.C2_ C2(c(start=0)) "cdc2k" annotation(Placement(visible=true, transformation(origin={20.0,60.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-270)));
      CellDivison.cell.CP_ CP(c(start=0.75)) "cdc2k-P" annotation(Placement(visible=true, transformation(origin={80.0,60.0}, extent={{-10.0,10.0},{10.0,-10.0}}, rotation=-90)));
      CellDivison.cell.M_ M(c(start=0)) "p-cyclin_cdc2" annotation(Placement(visible=true, transformation(origin={-80.0,-30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-90)));
      CellDivison.cell.pM_ pM(c(start=0.25)) "p-cyclin_cdc2-p" annotation(Placement(visible=true, transformation(origin={-10.0,-50.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
      CellDivison.cell.Y_ Y(c(start=0)) "cyclin" annotation(Placement(visible=true, transformation(origin={20.0,-30.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
      CellDivison.cell.YP_ YP(c(start=0)) "p-cyclin" annotation(Placement(visible=true, transformation(origin={-47.6389,-8.3553}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      CellDivison.cell.YT_ YT(c(start=0)) "total_cyclin" annotation(Placement(visible=true, transformation(origin={-70.0,70.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      CellDivison.cell.CT_ CT(c(start=0)) "total_cdc2" annotation(Placement(visible=true, transformation(origin={-40.0,-60.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      CellDivison.cell.Reaction1_ Reaction1 "cyclin_cdc2k dissociation" annotation(Placement(visible=true, transformation(origin={-70.0,20.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      CellDivison.cell.Reaction2_ Reaction2 "cdc2k phosphorylation" annotation(Placement(visible=true, transformation(origin={50.0,90.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      CellDivison.cell.Reaction3_ Reaction3 "cdc2k dephosphorylation" annotation(Placement(visible=true, transformation(origin={50.0,40.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
      CellDivison.cell.Reaction4_ Reaction4 "cyclin cdc2k-p association" annotation(Placement(visible=true, transformation(origin={48.1433,-70.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-90)));
      CellDivison.cell.Reaction5_ Reaction5 "deactivation of cdc2 kinase" annotation(Placement(visible=true, transformation(origin={-45.4898,-80.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
      CellDivison.cell.Reaction6_ Reaction6 "cyclin biosynthesis" annotation(Placement(visible=true, transformation(origin={-7.8911,-10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-90)));
      CellDivison.cell.Reaction7_ Reaction7 "default degradation of cyclin" annotation(Placement(visible=true, transformation(origin={50.0,-10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-270)));
      CellDivison.cell.Reaction8_ Reaction8 "cdc2 kinase triggered degration of cyclin" annotation(Placement(visible=true, transformation(origin={-30.0,20.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-270)));
      CellDivison.cell.Reaction9_ Reaction9 "activation of cdc2 kinase" annotation(Placement(visible=true, transformation(origin={-40.0,-40.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-180)));
    equation
      connect(CP.n1,Reaction2.p1) annotation(Line(visible=true, origin={73.75,80.0}, points={{6.25,-20.0},{6.25,10.0},{-12.5,10.0}}, smooth=Smooth.Bezier));
      connect(C2.n1,Reaction2.s1) annotation(Line(visible=true, origin={26.25,80.0}, points={{-6.25,-20.0},{-6.25,10.0},{12.5,10.0}}, smooth=Smooth.Bezier));
      connect(CP.n1,Reaction3.s1) annotation(Line(visible=true, origin={73.75,46.6667}, points={{6.25,13.3333},{6.25,-6.6667},{-12.5,-6.6667}}, smooth=Smooth.Bezier));
      connect(CP.n1,Reaction4.s1) annotation(Line(visible=true, origin={66.5716,-26.9367}, points={{13.4284,86.9367},{13.4284,-27.5617},{-13.4284,-27.5617},{-13.4284,-31.8133}}, smooth=Smooth.Bezier));
      connect(C2.n1,Reaction3.p1) annotation(Line(visible=true, origin={26.25,46.6667}, points={{-6.25,13.3333},{-6.25,-6.6667},{12.5,-6.6667}}, smooth=Smooth.Bezier));
      connect(C2.n1,Reaction1.p1) annotation(Line(visible=true, origin={-36.9367,42.5}, points={{56.9367,17.5},{-17.5617,17.5},{-17.5617,-17.5},{-21.8133,-17.5}}, smooth=Smooth.Bezier));
      connect(Y.n1,Reaction4.s2) annotation(Line(visible=true, origin={31.5716,-49.4367}, points={{-11.5716,19.4367},{-11.5716,-5.0617},{11.5716,-5.0617},{11.5716,-9.3133}}, smooth=Smooth.Bezier));
      connect(pM.n1,Reaction4.p1) annotation(Line(visible=true, origin={18.4573,-70.4506}, points={{-28.4573,20.4506},{-15.4573,20.4506},{-15.4573,-15.0509},{29.686,-15.0509},{29.686,-10.7994}}, smooth=Smooth.Bezier));
      connect(Y.n1,Reaction7.s1) annotation(Line(visible=true, origin={40.0,-27.0833}, points={{-20.0,-2.9167},{10.0,-2.9167},{10.0,5.8333}}, smooth=Smooth.Bezier));
      connect(Y.n1,Reaction6.p1) annotation(Line(visible=true, origin={1.4059,-27.0833}, points={{18.5941,-2.9167},{-9.297,-2.9167},{-9.297,5.8333}}, smooth=Smooth.Bezier));
      connect(M.n1,Reaction1.s1) annotation(Line(visible=true, origin={-82.4506,-4.8}, points={{2.4506,-25.2},{2.4506,-12.2},{-3.0509,-12.2},{-3.0509,24.8},{1.2006,24.8}}, smooth=Smooth.Bezier));
      connect(M.n1,Reaction5.s1) annotation(Line(visible=true, origin={-72.2466,-63.3333}, points={{-7.7534,33.3333},{-7.7534,-16.6667},{15.5068,-16.6667}}, smooth=Smooth.Bezier));
      connect(M.n1,Reaction9.p1) annotation(Line(visible=true, origin={-60.5633,-35.0}, points={{-19.4367,5.0},{5.0617,5.0},{5.0617,-5.0},{9.3133,-5.0}}, smooth=Smooth.Bezier));
      connect(pM.n1,Reaction5.p1) annotation(Line(visible=true, origin={-18.0799,-70.0}, points={{8.0799,20.0},{8.0799,-10.0},{-16.1599,-10.0}}, smooth=Smooth.Bezier));
      connect(pM.n1,Reaction9.s1) annotation(Line(visible=true, origin={-21.9367,-45.0}, points={{11.9367,-5.0},{-2.5617,-5.0},{-2.5617,5.0},{-6.8133,5.0}}, smooth=Smooth.Bezier));
      connect(CT.n1,Reaction9.m1) annotation(Line(visible=true, origin={-40.0,-52.6667}, points={{0.0,-7.3333},{0.0,3.6667},{0.0,3.6667}}, smooth=Smooth.Bezier));
      connect(EmptySet.n1,Reaction6.s1) annotation(Line(visible=true, origin={1.0545,8.0633}, points={{8.9456,11.9367},{8.9456,-2.5617},{-8.9456,-2.5617},{-8.9456,-6.8133}}, smooth=Smooth.Bezier));
      connect(EmptySet.n1,Reaction7.p1) annotation(Line(visible=true, origin={36.6667,13.75}, points={{-26.6667,6.25},{13.3333,6.25},{13.3333,-12.5}}, smooth=Smooth.Bezier));
      connect(EmptySet.n1,Reaction8.p1) annotation(Line(visible=true, origin={-11.2,28.4506}, points={{21.2,-8.4506},{8.2,-8.4506},{8.2,7.0509},{-18.8,7.0509},{-18.8,2.7994}}, smooth=Smooth.Bezier));
      connect(YP.n1,Reaction8.s1) annotation(Line(visible=true, origin={-35.8796,-2.6535}, points={{-11.7593,-5.7018},{5.8796,-5.7018},{5.8796,11.4035}}, smooth=Smooth.Bezier));
      connect(YP.n1,Reaction1.p2) annotation(Line(visible=true, origin={-51.3426,7.2149}, points={{3.7037,-15.5702},{3.7037,7.7851},{-7.4074,7.7851}}, smooth=Smooth.Bezier));
...
<img src=\"modelica://BioChem/Resources/Images/cytosol.png\" alt=\"Fig1: Simulation results\">
    ...
    <rdf:Description rdf:about=\"#metaid_0000005\">
      ...
      Endoplasmic_Reticulum.CaER_ CaER(c(start=0)) annotation(Placement(visible=true, transformation(origin={10.0,10.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-540)));
      input Real p1_sbml;
      input Real p2_sbml;
      input Real p3_sbml;
      ...
      Endoplasmic_Reticulum.Jch_ Jch(p1_sbml=p1_sbml, p2_sbml=p2_sbml, p3_sbml=p3_sbml) annotation(Placement(visible=true, transformation(origin={-80.0,-20.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-270)));
      Endoplasmic_Reticulum.Jleak_ Jleak annotation(Placement(visible=true, transformation(origin={-80.0,43.7135}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=-90)));
...
<a href=\"Modelica://BioChem.Examples.CaOscillations.Cytosol\">Cytosol</a>
 for more documentation and simulation results.
  ...
  package GlucoseInsulinModel
    extends BioChem.Icons.Example;
    annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Documentation(info="<html>
...
<a href=\"Modelica://BioChem.Examples.GlucoseInsulinModel.GlucoseInsulinModel\">GlucoseInsulinModel</a>
 for more documentation and simulation results.
    ...
    model GlucoseInsulinModel
      ...
      annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Rectangle(visible=true, origin={-39.6875,-1.36711}, fillColor={255,0,0}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, extent={{-55.2911,-15.5929},{55.2911,15.5929}}),Rectangle(visible=true, origin={-57.5522,-75}, fillColor={128,0,0}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, extent={{-40.931,-15},{40.931,15}}),Rectangle(visible=true, origin={-40.7051,-45.0134}, fillColor={128,0,0}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, extent={{-24.0839,-16.859},{24.0839,16.859}}),Rectangle(visible=true, origin={17.3745,60}, fillColor={255,170,127}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, extent={{-35,-18.3307},{35,18.3307}}),Rectangle(visible=true, origin={70,58.6765}, fillColor={255,170,127}, pattern=LinePattern.None, fillPattern=FillPattern.Solid, extent={{-20,-38.6765},{20,38.6765}}),Line(visible=true, origin={100,-55.25}, points={{-8.26,0},{8.26,0}}, color={0,0,128}, thickness=1),Text(visible=true, origin={126.135,-55.59}, fillPattern=FillPattern.Solid, extent={{-15.6548,-4.41},{15.6548,4.41}}, textString="Glucose flow", fontName="Arial"),Line(visible=true, origin={100,-66.03}, points={{-8.26,0},{8.26,0}}, color={0,0,255}, pattern=LinePattern.Dash),Line(visible=true, origin={100,-85.28}, points={{-8.26,0},{8.26,0}}, color={255,0,255}, pattern=LinePattern.Dash),Line(visible=true, origin={100,-75.36}, points={{-8.26,0},{8.26,0}}, color={128,0,128}, thickness=1),Text(visible=true, origin={128.34,-65.59}, fillPattern=FillPattern.Solid, extent={{-17.8596,-4.41},{17.8596,4.41}}, textString="Glucose signal", fontName="Arial"),Text(visible=true, origin={124.953,-75.59}, fillPattern=FillPattern.Solid, extent={{-13.3507,-4.41},{13.3507,4.41}}, textString="Insulin flow", fontName="Arial"),Text(visible=true, origin={126.987,-85.59}, fillPattern=FillPattern.Solid, extent={{-15.3871,-4.41},{15.3871,4.41}}, textString="Insulin signal", fontName="Arial")}), experiment(StartTime=0.0, StopTime=420, NumberOfIntervals=-1, Algorithm="dassl", Tolerance=1e-06), Documentation(info="<html>
<h1>A Whole Body Model of the Glucose Insulin System</h1>
...
<img src=\"modelica://BioChem/Resources/Images/Glucose4.png\" alt=\"Fig4: Simulation results\">
      ...
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.GastroIntestinalTract GastroIntestinalTract annotation(Placement(visible=true, transformation(origin={-50,80}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.TissueGlucose TissueGlucose annotation(Placement(visible=true, transformation(origin={0,60}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.GlucoseRenalExcretion GlucoseRenalExcretion annotation(Placement(visible=true, transformation(origin={125.793,-4.74893}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.PlasmaGlucose PlasmaGlucose annotation(Placement(visible=true, transformation(origin={0,0}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.PlasmaInsulin PlasmaInsulin annotation(Placement(visible=true, transformation(origin={-80,0}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.UtilizationMuscleTissue UtilizationMuscleTissue annotation(Placement(visible=true, transformation(origin={70,40}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.ReversibleFlowReaction k_1_k_2(k_1=0.065, k_2=0.079) annotation(Placement(visible=true, transformation(origin={0,30}, extent={{-6.52644,-6.52644},{6.52644,6.52644}}, rotation=-270)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.LiverInsulin LiverInsulin annotation(Placement(visible=true, transformation(origin={-80,-73.9076}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.EndogenousGlucoseProduction EndogenousGlucoseProduction annotation(Placement(visible=true, transformation(origin={-40,-45.0779}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.ReversibleFlowReaction m_1_m_2(k_2=0.484, k_1=0.19) annotation(Placement(visible=true, transformation(origin={-80,-36.3608}, extent={{-6.36084,6.36084},{6.36084,-6.36084}}, rotation=90)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.BetaCell BetaCell annotation(Placement(visible=true, transformation(origin={23.4019,-74.2468}, extent={{-10,-10},{10,10}}, rotation=0)));
      BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.AdiposeTissue.AdiposeTissue adiposeTissue1 annotation(Placement(visible=true, transformation(origin={70,80}, extent={{-10,-10},{10,10}}, rotation=0)));
    equation
      connect(UtilizationMuscleTissue.I_connector,PlasmaInsulin.I_signal_connector) annotation(Line(visible=true, origin={-35.44,35.5}, points={{94.44,12.857},{55.44,12.86},{48.33,64.5},{-52.076,70.3333},{-34.56,6.90118},{-26.6353,-15.5},{-24.56,-41.27},{-33.56,-41.27},{-33.56,-41.182}}, color={255,0,255}, pattern=LinePattern.Dash, arrow={Arrow.Open,Arrow.None}, smooth=Smooth.Bezier));
      connect(adiposeTissue1.I_connector,PlasmaInsulin.I_signal_connector) annotation(Line(visible=true, origin={-42.08,44.79}, points={{101.078,43.5978},{58.03,43.6},{12.08,61.3825},{-41.3655,52.9023},{-34.2421,19.3206},{-23.7266,-12.2259},{-17.92,-36.99},{-17.92,-47.1645},{-19.65,-50.22},{-26.92,-50.22},{-26.9223,-50.4722}}, color={255,0,255}, pattern=LinePattern.Dash, smooth=Smooth.Bezier));
      connect(TissueGlucose.U_idf_connector,adiposeTissue1.G_t_connector) annotation(Line(visible=true, origin={38.75,76.58}, points={{-27.75,-10.58},{-8.75,3.42},{16.25,3.58},{20.25,3.58}}, color={0,0,128}, thickness=1, arrow={Arrow.None,Arrow.Filled}, smooth=Smooth.Bezier));
      connect(BetaCell.G_connector,PlasmaGlucose.G_signal_connector) annotation(Line(visible=true, origin={-0.71,-20.49}, points={{24.11,-42.76},{22.75,-9.7},{-17.27,-9.7},{-17.27,20.49},{-10.29,20.68}}, color={0,0,255}, pattern=LinePattern.Dash, arrow={Arrow.Open,Arrow.None}, smooth=Smooth.Bezier));
      connect(BetaCell.G_p_connector,PlasmaGlucose.G_p_connector) annotation(Line(visible=true, origin={3.93,-21.62}, points={{26.99,-41.63},{26.31,-4.5},{-18.85,-4.5},{-18.85,14.62},{-14.93,14.62}}, color={0,0,255}, pattern=LinePattern.Dash, arrow={Arrow.Open,Arrow.None}, smooth=Smooth.Bezier));
      connect(GlucoseRenalExcretion.G_p_connector,PlasmaGlucose.G_p_connector) annotation(Line(visible=true, origin={37.56,-14.05}, points={{77.23,0.94},{56.28,-11.35},{-17.56,-11.35},{-52.49,-11.35},{-52.49,7.6},{-48.56,7.6},{-48.56,7.05}}, color={0,0,255}, pattern=LinePattern.Dash, arrow={Arrow.Open,Arrow.None}, smooth=Smooth.Bezier));
      connect(PlasmaGlucose.G_p_connector,EndogenousGlucoseProduction.G_p_connector) annotation(Line(visible=true, origin={-30.33,-16.03}, points={{19.33,9.03},{-9.67,9.03},{-9.67,-18.05}}, color={0,0,255}, pattern=LinePattern.Dash, arrow={Arrow.None,Arrow.Open}, smooth=Smooth.Bezier));
      connect(EndogenousGlucoseProduction.I_po_connector,BetaCell.I_po_connector) annotation(Line(visible=true, origin={1.27,-51.13}, points={{-30.27,6.06},{15.13,6.06},{15.13,-12.11}}, color={255,0,255}, pattern=LinePattern.Dash, arrow={Arrow.Open,Arrow.None}, smooth=Smooth.Bezier));
      connect(EndogenousGlucoseProduction.I_connector,PlasmaInsulin.I_signal_connector) annotation(Line(visible=true, origin={-54.49,-15.15}, points={{7.26,-18.93},{7.26,9.47},{-14.51,9.47}}, color={255,0,255}, pattern=LinePattern.Dash, arrow={Arrow.Open,Arrow.None}, smooth=Smooth.Bezier));
      connect(TissueGlucose.U_idm_connector,UtilizationMuscleTissue.G_t_connector) annotation(Line(visible=true, origin={45,46.91}, points={{-34,6.74021},{-12.0967,-6.91},{10,-6.74},{14,-6.748}}, color={0,0,128}, thickness=1, arrow={Arrow.None,Arrow.Filled}, smooth=Smooth.Bezier));
      connect(LiverInsulin.S_connector,BetaCell.S_connector) annotation(Line(visible=true, origin={-9.95,-74.17}, points={{-59.05,0.07},{18.35,0.07},{18.35,-0.07},{22.35,-0.07}}, color={128,0,128}, thickness=1, arrow={Arrow.Filled,Arrow.None}, smooth=Smooth.Bezier));
      connect(PlasmaGlucose.EGP_connector,EndogenousGlucoseProduction.EGP_connector) annotation(Line(visible=true, origin={-19.75,-20.03}, points={{19.58,9.03},{19.58,0.03},{-10.25,0.03},{-13.15,-4.55},{-12.87,-14.05}}, color={0,0,128}, thickness=1, arrow={Arrow.Filled,Arrow.None}, smooth=Smooth.Bezier));
      connect(PlasmaGlucose.E_connector,GlucoseRenalExcretion.productConnector1) annotation(Line(visible=true, origin={86.84,-4.8}, points={{-75.84,-0.05},{23.95,-0.05},{23.95,0.05},{27.95,0.05}}, color={0,0,128}, thickness=1, arrow={Arrow.None,Arrow.Filled}, smooth=Smooth.Bezier));
      connect(PlasmaGlucose.Ra_connector,GastroIntestinalTract.Ra_connector) annotation(Line(visible=true, origin={-28.9,31.7}, points={{21.1,-20.7},{21.1,-8.3},{-21.1,-8.3},{-21.1,37.3}}, color={0,0,128}, thickness=1, arrow={Arrow.Filled,Arrow.None}, smooth=Smooth.Bezier));
      connect(m_1_m_2.p1,PlasmaInsulin.I_connector) annotation(Line(visible=true, origin={-80,-20.1024}, points={{0,-9.10245},{0,9.10245}}, color={128,0,128}, thickness=1, smooth=Smooth.Bezier));
      connect(m_1_m_2.s1,LiverInsulin.I_connector) annotation(Line(visible=true, origin={-80,-53.2122}, points={{0,9.6954},{0,-9.6954}}, color={128,0,128}, thickness=1, smooth=Smooth.Bezier));
      connect(k_1_k_2.p1,TissueGlucose.G_connector) annotation(Line(visible=true, origin={0,43.17}, points={{0,-5.83},{0,5.83}}, color={0,0,128}, thickness=1, smooth=Smooth.Bezier));
      connect(k_1_k_2.s1,PlasmaGlucose.G_connector) annotation(Line(visible=true, origin={0,16.83}, points={{0,5.83},{0,-5.83}}, color={0,0,128}, thickness=1, smooth=Smooth.Bezier));
    ...
    package Utilities
      ...
      package Parts
        ...
        model GastroIntestinalTract
          ...
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={-7.23323,45}, fillPattern=FillPattern.Solid, extent={{-45,-45},{45,45}}, textString="GI", fontName="Arial"),Text(visible=true, origin={-2.44435,-51.2385}, fillPattern=FillPattern.Solid, extent={{-93.0638,-41.2385},{93.0638,41.2385}}, textString="tract", fontName="Arial")}));
          ...
          BioChem.Substances.Substance Q_sto2(c.start=0) annotation(Placement(visible=true, transformation(origin={0,50}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.Substance Q_gut(c.start=0) annotation(Placement(visible=true, transformation(origin={0,-20}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction k_abs(k=0.057) annotation(Placement(visible=true, transformation(origin={38.33,-20}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.k_empt k_empt1 annotation(Placement(visible=true, transformation(origin={0,17.8419}, extent={{-10,-10},{10,10}}, rotation=-90)));
          BioChem.Substances.Substance Q_sto1(c.start=0) annotation(Placement(visible=true, transformation(origin={-60,50}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.dirac dirac annotation(Placement(visible=true, transformation(origin={-100,50}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance Q_sto(c(start=0)=q_sto) annotation(Placement(visible=true, transformation(origin={100,30}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance D(c(start=0)=d) annotation(Placement(visible=true, transformation(origin={100,5.76656}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.SubstrateConnector Ra_connector annotation(Placement(visible=true, transformation(origin={0,-80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={0,-110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.BoundarySubstance GlucoseIntake(c.start=78000) annotation(Placement(visible=true, transformation(origin={-130,50}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction k_gri(k=0.0558) annotation(Placement(visible=true, transformation(origin={-28.43,50}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.BoundarySubstance End annotation(Placement(visible=true, transformation(origin={80,-20}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance Ra_calc(c=ra_signal) annotation(Placement(visible=true, transformation(origin={0,-50}, extent={{-10,-10},{10,10}}, rotation=0)));
        equation
          connect(Ra_calc.n1,Ra_connector) annotation(Line(visible=true, origin={0,-65}, points={{0,15},{0,-15}}));
          connect(k_abs.p1,End.n1) annotation(Line(visible=true, origin={64.79,-20}, points={{-15.21,0},{15.21,0}}));
          connect(Q_sto1.n1,k_gri.s1) annotation(Line(visible=true, origin={-49.84,50}, points={{-10.16,0},{10.16,0}}));
          connect(k_gri.p1,Q_sto2.n1) annotation(Line(visible=true, origin={-8.59,50}, points={{-8.59,0},{8.59,0}}));
          connect(GlucoseIntake.n1,dirac.s1) annotation(Line(visible=true, origin={-120.625,50}, points={{-9.375,0},{9.375,0}}));
          connect(D.n1,k_empt1.m2) annotation(Line(visible=true, origin={34.2512,9.30423}, points={{65.7488,-3.53767},{-20.2487,-3.53767},{-20.2487,3.53767},{-25.2512,3.53767}}));
          connect(Q_sto.n1,k_empt1.m1) annotation(Line(visible=true, origin={34.2512,26.4209}, points={{65.7488,3.57905},{-20.2487,3.57905},{-20.2487,-3.57905},{-25.2512,-3.57905}}));
          connect(dirac.p1,Q_sto1.n1) annotation(Line(visible=true, origin={-74.375,50}, points={{-14.375,0},{14.375,0}}));
          connect(k_empt1.p1,Q_gut.n1) annotation(Line(visible=true, origin={1.11022e-17,-6.70406}, points={{1.11022e-17,13.2959},{-1.11022e-17,-13.2959}}));
          connect(Q_sto2.n1,k_empt1.s1) annotation(Line(visible=true, origin={-1.11022e-17,39.5459}, points={{1.11022e-17,10.4541},{-1.11022e-17,-10.4541}}));
          connect(Q_gut.n1,k_abs.s1) annotation(Line(visible=true, origin={13.54,-20}, points={{-13.54,0},{13.54,0}}));
        ...
        model BetaCell
          extends BioChem.Compartments.Compartment(V.start=1.0);
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={-2.41533,43.4019}, fillPattern=FillPattern.Solid, extent={{-75.99,-51.46},{75.99,51.46}}, textString="Beta", fontName="Arial"),Text(visible=true, origin={1.61,-49.34}, fillPattern=FillPattern.Solid, extent={{-73.89,-40.66},{73.89,40.66}}, textString="cell", fontName="Arial")}));
          ...
          BioChem.Interfaces.Nodes.ModifierConnector G_connector annotation(Placement(visible=true, transformation(origin={0,80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={0,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.SubstrateConnector S_connector annotation(Placement(visible=true, transformation(origin={-120,-8.88178e-16}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,0}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector I_po_connector annotation(Placement(visible=true, transformation(origin={-90,80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-70,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector G_p_connector annotation(Placement(visible=true, transformation(origin={100,80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={75.1683,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance S_calc(c=s_signal) annotation(Placement(visible=true, transformation(origin={-90,0}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.signaltosubstance signaltosubstance1 annotation(Placement(visible=true, transformation(origin={2.22045e-16,60}, extent={{-10,-10},{10,10}}, rotation=-90)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.signaltosubstance signaltosubstance2 annotation(Placement(visible=true, transformation(origin={100,60}, extent={{-10,-10},{10,10}}, rotation=-90)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.signaltosubstance signaltosubstance3 annotation(Placement(visible=true, transformation(origin={60,-30}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance I_po_signal(c=i_po) annotation(Placement(visible=true, transformation(origin={-90,40}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.Substance G(c=g) annotation(Placement(visible=true, transformation(origin={0,40}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.Substance G_p(c=g_p) annotation(Placement(visible=true, transformation(origin={100,40}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.Substance Y(c=y) annotation(Placement(visible=true, transformation(origin={80,-30}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance Y_signal(c=y_signal) annotation(Placement(visible=true, transformation(origin={40,-30}, extent={{-10,-10},{10,10}}, rotation=0)));
        equation
          connect(Y_signal.n1,signaltosubstance3.s1) annotation(Line(visible=true, origin={42.9167,-30}, points={{-2.91667,3.55271e-15},{-2.91667,-3.55271e-15},{5.83333,-3.55271e-15}}));
          connect(signaltosubstance3.p1,Y.n1) annotation(Line(visible=true, origin={74.1667,-30}, points={{-2.91667,0},{-2.91667,0},{5.83333,0}}));
          connect(signaltosubstance2.p1,G_p.n1) annotation(Line(visible=true, origin={100,42.9167}, points={{0,5.83333},{0,-2.91667},{0,-2.91667}}));
          connect(signaltosubstance1.p1,G.n1) annotation(Line(visible=true, origin={1.62833e-16,42.9167}, points={{8.14164e-17,5.83333},{8.14164e-17,-2.91667},{-1.62833e-16,-2.91667}}));
          connect(I_po_connector,I_po_signal.n1) annotation(Line(visible=true, origin={-90,60}, points={{0,20},{0,-20}}));
          connect(G_p_connector,signaltosubstance2.s1) annotation(Line(visible=true, origin={100,75.625}, points={{0,4.375},{0,-4.375}}));
          connect(G_connector,signaltosubstance1.s1) annotation(Line(visible=true, origin={9.99201e-17,75.625}, points={{-9.99201e-17,4.375},{9.99201e-17,-4.375}}));
          connect(S_calc.n1,S_connector) annotation(Line(visible=true, origin={-105,-4.44089e-16}, points={{15,4.44089e-16},{-15,-4.44089e-16}}));
        ...
        model PlasmaInsulin
          extends BioChem.Compartments.Compartment(V.start=1.0);
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={-7.10543e-15,46.05}, fillPattern=FillPattern.Solid, extent={{-93.8311,-36.05},{93.8311,36.05}}, textString="Plasma", fontName="Arial"),Text(visible=true, origin={-3.55271e-15,-36.936}, fillPattern=FillPattern.Solid, extent={{-86.0653,-45},{86.0653,45}}, textString="insulin", fontName="Arial")}));
          ...
          BioChem.Substances.Substance I_p(c(start=1.25)=i_p) annotation(Placement(visible=true, transformation(origin={0,0}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction m_4(k=0.194) annotation(Placement(visible=true, transformation(origin={-60,0}, extent={{10,-10},{-10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector I_p_connector annotation(Placement(visible=true, transformation(origin={120,0}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={110,4.44089e-16}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ProductConnector I_connector annotation(Placement(visible=true, transformation(origin={0,-80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={0,-110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector I_signal_connector annotation(Placement(visible=true, transformation(origin={120,-30}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={110,-56.82}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance I_p_signal(c=i_p_signal) annotation(Placement(visible=true, transformation(origin={60,7.77156e-16}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance I_signal(c=i_signal) annotation(Placement(visible=true, transformation(origin={60,-30}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.BoundarySubstance Deg annotation(Placement(visible=true, transformation(origin={-120,0}, extent={{-10,-10},{10,10}}, rotation=0)));
        equation
          connect(Deg.n1,m_4.p1) annotation(Line(visible=true, origin={-95.625,1.11022e-17}, points={{-24.375,-1.11022e-17},{24.375,1.11022e-17}}));
          connect(I_signal.n1,I_signal_connector) annotation(Line(visible=true, origin={90,-30}, points={{-30,0},{30,0}}));
          connect(I_p_signal.n1,I_p_connector) annotation(Line(visible=true, origin={90,3.88578e-16}, points={{-30,3.88578e-16},{30,-3.88578e-16}}));
          connect(I_p.n1,I_connector) annotation(Line(visible=true, origin={0,-40}, points={{0,40},{0,-40}}));
          connect(m_4.s1,I_p.n1) annotation(Line(visible=true, origin={-24.375,-1.11022e-17}, points={{-24.375,-1.11022e-17},{24.375,1.11022e-17}}));
          i_p_signal=i_p;
          i_signal=i_p/V_I;
        end PlasmaInsulin;
        ...
        model PlasmaGlucose
          extends BioChem.Compartments.Compartment(V.start=1.0);
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={9.76996e-15,43.56}, fillPattern=FillPattern.Solid, extent={{-83.88,-33.56},{83.88,33.56}}, textString="Plasma", fontName="Arial"),Text(visible=true, origin={2.66454e-15,-40}, fillPattern=FillPattern.Solid, extent={{-86.96,-35.65},{86.96,35.65}}, textString="glucose", fontName="Arial")}));
          parameter Real V_G=1.88;
          BioChem.Units.Concentration g_p_signal;
          BioChem.Units.Concentration g_p;
          BioChem.Units.Concentration g_signal;
          BioChem.Interfaces.Nodes.ProductConnector EGP_connector annotation(Placement(visible=true, transformation(origin={4.44089e-16,-80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-1.73862,-110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector G_p_connector annotation(Placement(visible=true, transformation(origin={-110,-70}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,-70}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.SubstrateConnector E_connector annotation(Placement(visible=true, transformation(origin={120,-30}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={110,-48.4304}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ProductConnector Ra_connector annotation(Placement(visible=true, transformation(origin={-80,80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-77.9724,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.SubstrateConnector G_connector annotation(Placement(visible=true, transformation(origin={0,80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={0,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance G_p_signal(c=g_p_signal) annotation(Placement(visible=true, transformation(origin={-110,-23.3921}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance G_signal(c=g_signal) annotation(Placement(visible=true, transformation(origin={-120,40}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector G_signal_connector annotation(Placement(visible=true, transformation(origin={-120,0}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,1.94}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.Substance G_p(c.start=178, c=g_p) annotation(Placement(visible=true, transformation(origin={0,0}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction Ra_reaction(k=1) annotation(Placement(visible=true, transformation(origin={-80,50}, extent={{-10,-10},{10,10}}, rotation=-90)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction EGP_reaction(k=1) annotation(Placement(visible=true, transformation(origin={0,-48}, extent={{-10,10},{10,-10}}, rotation=90)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.U_ii_reaction u_ii_reaction1 annotation(Placement(visible=true, transformation(origin={90,30}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.BoundarySubstance U_ii annotation(Placement(visible=true, transformation(origin={120,30}, extent={{-10,-10},{10,10}}, rotation=0)));
        equation
          connect(U_ii.n1,u_ii_reaction1.p1) annotation(Line(visible=true, origin={110.625,30}, points={{9.375,0},{-9.375,0}}));
          connect(G_p.n1,u_ii_reaction1.s1) annotation(Line(visible=true, origin={56.9367,15}, points={{-56.9367,-15},{17.5617,-15},{17.5617,15},{21.8133,15}}));
          connect(EGP_reaction.s1,EGP_connector) annotation(Line(visible=true, origin={2.10942e-16,-69.625}, points={{-2.33147e-16,10.375},{2.33147e-16,-10.375}}));
          connect(G_p.n1,EGP_reaction.p1) annotation(Line(visible=true, origin={1.11022e-17,-18.375}, points={{-1.11022e-17,18.375},{1.11022e-17,-18.375}}));
          connect(Ra_connector,Ra_reaction.s1) annotation(Line(visible=true, origin={-80,70.625}, points={{0,9.375},{0,-9.375}}));
          connect(Ra_reaction.p1,G_p.n1) annotation(Line(visible=true, origin={-53.3333,12.9167}, points={{-26.6667,25.8333},{-26.6667,-12.9167},{53.3333,-12.9167}}));
          connect(G_p.n1,E_connector) annotation(Line(visible=true, origin={83.5,-15}, points={{-83.5,15},{23.5,15},{23.5,-15},{36.5,-15}}));
          connect(G_p.n1,G_connector) annotation(Line(visible=true, origin={0,40}, points={{0,-40},{0,40}}));
          connect(G_p_signal.n1,G_p_connector) annotation(Line(visible=true, origin={-110,-46.696}, points={{0,23.304},{0,-23.304}}));
          connect(G_signal.n1,G_signal_connector) annotation(Line(visible=true, origin={-120,20}, points={{0,20},{0,-20}}));
          g_p_signal=g_p;
        ...
        model LiverInsulin
          extends BioChem.Compartments.Compartment(V.start=1.0);
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={0.247749,43.7203}, fillPattern=FillPattern.Solid, extent={{-92.2066,-43.7203},{92.2066,43.7203}}, textString="Liver", fontName="Arial"),Text(visible=true, origin={-0.875609,-51.2968}, fillPattern=FillPattern.Solid, extent={{-89.1244,-31.2968},{89.1244,31.2968}}, textString="insulin", fontName="Arial")}));
          BioChem.Units.Concentration s;
          BioChem.Units.Concentration s_signal;
          BioChem.Substances.Substance I_l(c.start=5) annotation(Placement(visible=true, transformation(origin={0,0}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance S_signal(c=s_signal) annotation(Placement(visible=true, transformation(origin={-70,50}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.m_3 m_3 annotation(Placement(visible=true, transformation(origin={-70,0}, extent={{10,-10},{-10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ProductConnector S_connector(c=s) annotation(Placement(visible=true, transformation(origin={120,0}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={110,-1.93864}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.SubstrateConnector I_connector annotation(Placement(visible=true, transformation(origin={7.10543e-15,79.59}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={0,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction S_reaction(k=1) annotation(Placement(visible=true, transformation(origin={70,-7.21645e-16}, extent={{10,-10},{-10,10}}, rotation=0)));
          BioChem.Substances.BoundarySubstance Deg annotation(Placement(visible=true, transformation(origin={-120,0}, extent={{-10,-10},{10,10}}, rotation=0)));
        equation
          connect(m_3.p1,Deg.n1) annotation(Line(visible=true, origin={-100.625,1.11022e-17}, points={{19.375,1.11022e-17},{-19.375,-1.11022e-17}}));
          connect(S_reaction.s1,S_connector) annotation(Line(visible=true, origin={100.625,-3.71925e-16}, points={{-19.375,-3.71925e-16},{19.375,3.71925e-16}}));
          connect(S_reaction.p1,I_l.n1) annotation(Line(visible=true, origin={29.375,-3.4972e-16}, points={{29.375,-3.4972e-16},{-29.375,3.4972e-16}}));
          connect(I_connector,I_l.n1) annotation(Line(visible=true, origin={3.55271e-15,39.795}, points={{3.55271e-15,39.795},{-3.55271e-15,-39.795}}));
          connect(I_l.n1,m_3.s1) annotation(Line(visible=true, origin={-29.375,-1.11022e-17}, points={{29.375,1.11022e-17},{-29.375,-1.11022e-17}}));
          connect(S_signal.n1,m_3.m1) annotation(Line(visible=true, origin={-70,29.5}, points={{0,20.5},{0,-20.5}}));
          s=s_signal;
        end LiverInsulin;

        model EndogenousGlucoseProduction
          extends BioChem.Compartments.Compartment(V.start=1.0);
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={-107.257,0}, rotation=-270, fillPattern=FillPattern.Solid, extent={{-25.4753,-2.74277},{25.4753,2.74277}}, textString="delayed insulin signal", fontName="Arial")}), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={4.68254,4.83}, fillPattern=FillPattern.Solid, extent={{-77.28,-45.17},{77.28,45.17}}, textString="EGP", fontName="Arial")}));
          ...
          BioChem.Interfaces.Nodes.ModifierConnector G_p_connector annotation(Placement(visible=true, transformation(origin={0,80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={2.22045e-16,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.SubstrateConnector EGP_connector annotation(Placement(visible=true, transformation(origin={60,80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={73.83,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector I_connector annotation(Placement(visible=true, transformation(origin={-60,80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-72.29,110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector I_po_connector annotation(Placement(visible=true, transformation(origin={120,-60}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={110,0}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction k_i1(k=0.0079) annotation(Placement(visible=true, transformation(origin={-90,63.2158}, extent={{10,-10},{-10,10}}, rotation=-270)));
          BioChem.Substances.Substance I_1(c.start=25) annotation(Placement(visible=true, transformation(origin={-90,40}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction k_i2(k=0.0079) annotation(Placement(visible=true, transformation(origin={-90,10}, extent={{10,-10},{-10,10}}, rotation=-270)));
          BioChem.Substances.Substance I_d(c.start=25, c=i_d) annotation(Placement(visible=true, transformation(origin={-90,-10}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.FlowReaction k_i3(k=0.0079) annotation(Placement(visible=true, transformation(origin={-90,-40}, extent={{10,-10},{-10,10}}, rotation=-270)));
          BioChem.Substances.BoundarySubstance End annotation(Placement(visible=true, transformation(origin={-90,-60}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.SignalSubstance EGP_calc(c=egp_signal) annotation(Placement(visible=true, transformation(origin={60,40}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.Substance G_p(c=g_p) annotation(Placement(visible=true, transformation(origin={8.88178e-16,40}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.Substance I_po(c=i_po) annotation(Placement(visible=true, transformation(origin={80,-60}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.signaltosubstance signaltosubstance1 annotation(Placement(visible=true, transformation(origin={100,-60}, extent={{10,-10},{-10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.signaltosubstance signaltosubstance2 annotation(Placement(visible=true, transformation(origin={0,60}, extent={{-10,-10},{10,10}}, rotation=-90)));
        equation
          connect(signaltosubstance2.p1,G_p.n1) annotation(Line(visible=true, origin={3.10862e-16,42.9167}, points={{-2.88658e-16,5.83333},{-2.88658e-16,-2.91667},{5.77316e-16,-2.91667}}));
          connect(G_p_connector,signaltosubstance2.s1) annotation(Line(visible=true, origin={-7.4015e-18,74.1667}, points={{7.4015e-18,5.83333},{7.4015e-18,-2.91667},{-1.4803e-17,-2.91667}}));
          connect(I_po_connector,signaltosubstance1.s1) annotation(Line(visible=true, origin={115.625,-60}, points={{4.375,0},{-4.375,0}}));
          connect(signaltosubstance1.p1,I_po.n1) annotation(Line(visible=true, origin={84.375,-60}, points={{4.375,0},{-4.375,0}}));
          connect(EGP_calc.n1,EGP_connector) annotation(Line(visible=true, origin={60,60}, points={{0,-20},{0,20}}));
          connect(End.n1,k_i3.p1) annotation(Line(visible=true, origin={-90,-54.1667}, points={{0,-5.83333},{0,2.91667},{0,2.91667}}));
          connect(k_i3.s1,I_d.n1) annotation(Line(visible=true, origin={-90,-19.375}, points={{0,-9.375},{0,9.375}}));
          connect(k_i2.p1,I_d.n1) annotation(Line(visible=true, origin={-90,-7.08333}, points={{0,5.83333},{0,-2.91667},{0,-2.91667}}));
          connect(I_1.n1,k_i2.s1) annotation(Line(visible=true, origin={-90,30.625}, points={{0,9.375},{0,-9.375}}));
          connect(k_i1.p1,I_1.n1) annotation(Line(visible=true, origin={-90,43.9886}, points={{0,7.97721},{0,-3.9886},{0,-3.9886}}));
          connect(k_i1.s1,I_connector) annotation(Line(visible=true, origin={-80,78.1553}, points={{-10,-3.68946},{-10,1.84473},{20,1.84473}}));
          egp_signal=k_p1 - k_p2*g_p - k_p3*i_d - k_p4*i_po;
        end EndogenousGlucoseProduction;

        model GlucoseRenalExcretion
          extends BioChem.Compartments.Compartment(V.start=1.0);
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={-3.87096,37.0935}, fillPattern=FillPattern.Solid, extent={{-89.7,-30},{89.7,30}}, textString="Renal", fontName="Arial"),Text(visible=true, origin={-3.55271e-15,-46.0442}, fillPattern=FillPattern.Solid, extent={{-95.9469,-26.0442},{95.9469,26.0442}}, textString="excretion", fontName="Arial")}));
          BioChem.Interfaces.Nodes.ProductConnector productConnector1 annotation(Placement(visible=true, transformation(origin={-120,-4.44089e-16}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,3.33067e-16}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.RenalReaction renalReaction1 annotation(Placement(visible=true, transformation(origin={-90,3.88578e-16}, extent={{-10,10},{10,-10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ModifierConnector G_p_connector annotation(Placement(visible=true, transformation(origin={-120,-70}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,-83.5976}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.BoundarySubstance E annotation(Placement(visible=true, transformation(origin={0,0}, extent={{-10,-10},{10,10}}, rotation=0)));
        equation
          connect(renalReaction1.p1,E.n1) annotation(Line(visible=true, origin={-39.375,1.83187e-16}, points={{-39.375,1.83187e-16},{39.375,-1.83187e-16}}));
          connect(G_p_connector,G_p_connector) annotation(Line(visible=true, origin={-120,-70}, points={{0,0},{0,0}}));
          connect(G_p_connector,renalReaction1.m1) annotation(Line(visible=true, origin={-75,-82.7488}, points={{-45,12.7488},{-15,12.7487},{-15,12.7488},{-15,73.7488}}));
          connect(productConnector1,renalReaction1.s1) annotation(Line(visible=true, origin={-110.625,-1.66533e-17}, points={{-9.375,-4.27436e-16},{9.375,4.27436e-16}}));
        end GlucoseRenalExcretion;

        model UtilizationMuscleTissue
          extends BioChem.Compartments.Compartment(V.start=1.0);
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={-2.91,52.76}, fillPattern=FillPattern.Solid, extent={{-82.91,-30.17},{82.91,30.17}}, textString="Muscle", fontName="Arial"),Text(visible=true, origin={-7.10543e-15,-34.69}, fillPattern=FillPattern.Solid, extent={{-77.92,-34.69},{77.92,34.69}}, textString="tissue", fontName="Arial")}));
          BioChem.Interfaces.Nodes.ModifierConnector I_connector annotation(Placement(visible=true, transformation(origin={-120,50}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,83.5696}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.ProductConnector G_t_connector annotation(Placement(visible=true, transformation(origin={-120,0}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,1.62}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.BoundarySubstance U_idm annotation(Placement(visible=true, transformation(origin={0,0}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.UtilizationReaction UtilizationReaction(K_m0=225.59, V_m0=2.5, V_mX=0.047, p_2U=0.0331, part=0.8) annotation(Placement(visible=true, transformation(origin={-64.11,0}, extent={{-10,-10},{10,10}}, rotation=0)));
        equation
          connect(UtilizationReaction.p1,U_idm.n1) annotation(Line(visible=true, origin={-26.43,1.11022e-17}, points={{-26.43,1.11022e-17},{26.43,-1.11022e-17}}));
          connect(UtilizationReaction.m1,I_connector) annotation(Line(visible=true, origin={-82.74,36.3333}, points={{18.63,-27.3333},{18.63,13.6667},{-37.26,13.6667}}));
          connect(G_t_connector,UtilizationReaction.s1) annotation(Line(visible=true, origin={-97.68,-1.11022e-17}, points={{-22.32,1.11022e-17},{22.32,-1.11022e-17}}));
        end UtilizationMuscleTissue;

        model TissueGlucose
          extends BioChem.Compartments.Compartment(V.start=1.0);
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={-0.55,-36.0512}, fillPattern=FillPattern.Solid, extent={{-100.55,-33.9488},{100.55,33.9488}}, textString="glucose", fontName="Arial"),Text(visible=true, origin={3.56664,43.6442}, fillPattern=FillPattern.Solid, extent={{-86.4334,-33.6442},{86.4334,33.6442}}, textString="Tissue", fontName="Arial")}));
          BioChem.Interfaces.Nodes.ProductConnector G_connector annotation(Placement(visible=true, transformation(origin={0,-80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={0,-110}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Substances.Substance G_t(c.start=130) annotation(Placement(visible=true, transformation(origin={0,0}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.SubstrateConnector U_idf_connector annotation(Placement(visible=true, transformation(origin={120,40}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={110,60}, extent={{-10,-10},{10,10}}, rotation=0)));
          BioChem.Interfaces.Nodes.SubstrateConnector U_idm_connector annotation(Placement(visible=true, transformation(origin={120,-40}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={110,-63.4979}, extent={{-10,-10},{10,10}}, rotation=0)));
        equation
          connect(G_t.n1,U_idm_connector) annotation(Line(visible=true, origin={83.5,-20}, points={{-83.5,20},{23.5,20},{23.5,-20},{36.5,-20}}));
          connect(G_t.n1,U_idf_connector) annotation(Line(visible=true, origin={83.5,20}, points={{-83.5,-20},{23.5,-20},{23.5,20},{36.5,20}}));
          connect(G_t.n1,G_connector) annotation(Line(visible=true, origin={0,-40}, points={{0,40},{0,-40}}));
        end TissueGlucose;
        ...
        package AdiposeTissue
          ...
          model Adipocyte
            ...
            BioChem.Substances.Substance IR(c.start=2340000000000.0) annotation(Placement(visible=true, transformation(origin={-110,60}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.SignalSubstance IR_tot annotation(Placement(visible=true, transformation(origin={110,60}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.Substance IRS1(c.start=16100000000.0) annotation(Placement(visible=true, transformation(origin={-80,30}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.Substance IRS1_P(c.start=0) annotation(Placement(visible=true, transformation(origin={-20,30}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.ActivationReaction activationReaction2(k_1=0.038, k_2=580000000) annotation(Placement(visible=true, transformation(origin={-50,30}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.ActivationReaction activationReaction3(k_1=1.348, k_2=24800000) annotation(Placement(visible=true, transformation(origin={-20,0}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.Substance PKB(c.start=16800000) annotation(Placement(visible=true, transformation(origin={-50,0}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.Substance PKB_P(c.start=0) annotation(Placement(visible=true, transformation(origin={10,0}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.ActivationReaction activationReaction4(k_1=0.019, k_2=336000000) annotation(Placement(visible=true, transformation(origin={10,-30}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.SignalSubstance IRS1_tot annotation(Placement(visible=true, transformation(origin={110,30}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.SignalSubstance PKB_tot annotation(Placement(visible=true, transformation(origin={110,0}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.SignalSubstance GLUT4_tot annotation(Placement(visible=true, transformation(origin={110,-30}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.BoundarySubstance GlucoseUtilization annotation(Placement(visible=true, transformation(origin={110,-80}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Interfaces.Nodes.ModifierConnector modifierConnector1 annotation(Placement(visible=true, transformation(origin={-80,90}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,0}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Interfaces.Nodes.ProductConnector productConnector1 annotation(Placement(visible=true, transformation(origin={-7.77156e-16,-80}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-1.22125e-15,-110}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.Substance GLUT4_MEMBRANE(c.start=0) annotation(Placement(visible=true, transformation(origin={40,-30}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.Substance GLUT4_CYTOSOL(c.start=580000000) annotation(Placement(visible=true, transformation(origin={-20,-30}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Substances.Substance IR_insulin(c.start=0) annotation(Placement(visible=true, transformation(origin={-50,60}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.MM_insulin MM_insulin1(k_1=2.464, k_2=54100000000.0, Km=1499) annotation(Placement(visible=true, transformation(origin={-80,60}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Examples.GlucoseInsulinModel.Utilities.Reactions.GlucoseUptakeReaction GlucoseUptake_GLUT4(k=12.435, glut_1=0.071, Km1=0.012, Km4=3462, k_wholebody=2.45) annotation(Placement(visible=true, transformation(origin={40,-80}, extent={{-10,-10},{10,10}}, rotation=0)));
          equation
            connect(productConnector1,GlucoseUptake_GLUT4.s1) annotation(Line(visible=true, origin={14.375,-80}, points={{-14.375,0},{14.375,0}}));
            connect(GlucoseUptake_GLUT4.p1,GlucoseUtilization.n1) annotation(Line(visible=true, origin={80.625,-80}, points={{-29.375,0},{29.375,0}}));
            connect(GLUT4_MEMBRANE.n1,GlucoseUptake_GLUT4.m1) annotation(Line(visible=true, origin={40,-50.5}, points={{0,20.5},{0,-20.5}}));
            connect(MM_insulin1.p1,IR_insulin.n1) annotation(Line(visible=true, origin={-59.375,60}, points={{-9.375,0},{9.375,0}}));
            connect(modifierConnector1,MM_insulin1.m1) annotation(Line(visible=true, origin={-80,79.5}, points={{0,10.5},{0,-10.5}}));
            connect(IR.n1,MM_insulin1.s1) annotation(Line(visible=true, origin={-100.625,60}, points={{-9.375,0},{9.375,0}}));
            connect(IR_insulin.n1,activationReaction2.m1) annotation(Line(visible=true, origin={-50,49.5}, points={{0,10.5},{0,-10.5}}));
            connect(GLUT4_CYTOSOL.n1,activationReaction4.s1) annotation(Line(visible=true, origin={-10.625,-30}, points={{-9.375,0},{9.375,0}}));
            connect(activationReaction4.p1,GLUT4_MEMBRANE.n1) annotation(Line(visible=true, origin={30.625,-30}, points={{-9.375,0},{9.375,0}}));
            IR_tot.c=IR.c + IR_insulin.c;
            IRS1_tot.c=IRS1.c + IRS1_P.c;
            PKB_tot.c=PKB.c + PKB_P.c;
            GLUT4_tot.c=GLUT4_CYTOSOL.c + GLUT4_MEMBRANE.c;
            connect(PKB_P.n1,activationReaction4.m1) annotation(Line(visible=true, origin={10,-10.5}, points={{0,10.5},{-1.77636e-15,-10.5}}));
            connect(activationReaction3.p1,PKB_P.n1) annotation(Line(visible=true, origin={0.625,1.11022e-17}, points={{-9.375,1.11022e-17},{9.375,-1.11022e-17}}));
            connect(PKB.n1,activationReaction3.s1) annotation(Line(visible=true, origin={-40.625,1.11022e-17}, points={{-9.375,-1.11022e-17},{9.375,1.11022e-17}}));
            connect(IRS1_P.n1,activationReaction3.m1) annotation(Line(visible=true, origin={-20,19.5}, points={{0,10.5},{0,-10.5}}));
            connect(activationReaction2.p1,IRS1_P.n1) annotation(Line(visible=true, origin={-29.375,30}, points={{-9.375,-3.55271e-15},{9.375,0}}));
            connect(IRS1.n1,activationReaction2.s1) annotation(Line(visible=true, origin={-70.625,30}, points={{-9.375,0},{9.375,0}}));
          end Adipocyte;

          model AdiposeTissue
            extends BioChem.Compartments.Compartment(V.start=1.0);
            annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})), Icon(coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Text(visible=true, origin={-3.97,38.38}, fillPattern=FillPattern.Solid, extent={{-96.03,-31.62},{96.03,31.62}}, textString="Fat", fontName="Arial"),Text(visible=true, origin={-2.5601,-40}, fillPattern=FillPattern.Solid, extent={{-77.4399,-42.4487},{77.4399,42.4487}}, textString="tissue", fontName="Arial")}));
            BioChem.Interfaces.Nodes.ModifierConnector I_connector annotation(Placement(visible=true, transformation(origin={-120,50}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,83.8877}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Interfaces.Nodes.ProductConnector G_t_connector annotation(Placement(visible=true, transformation(origin={-120,0}, extent={{-10,-10},{10,10}}, rotation=0), iconTransformation(origin={-110,1.61}, extent={{-10,-10},{10,10}}, rotation=0)));
            BioChem.Examples.GlucoseInsulinModel.Utilities.Parts.AdiposeTissue.Adipocyte adipocyte1 annotation(Placement(visible=true, transformation(origin={0,6.66134e-16}, extent={{-10,-10},{10,10}}, rotation=0)));
          equation
            connect(adipocyte1.productConnector1,G_t_connector) annotation(Line(visible=true, origin={-66.8,-8.2005}, points={{66.8,-2.7995},{66.8,-6.80075},{-40.2,-6.80075},{-40.2,8.2005},{-53.2,8.2005}}));
            connect(I_connector,adipocyte1.modifierConnector1) annotation(Line(visible=true, origin={-40.2506,25}, points={{-79.7494,25},{25.2494,25},{25.2494,-25},{29.2506,-25}}));
          end AdiposeTissue;
      ...
      package Reactions
        ...
        model FlowReaction
          extends BioChem.Interfaces.Reactions.Uui;
          annotation(Diagram(coordinateSystem(extent={{-148.5,-105},{148.5,105}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10})));
          parameter Real k;
        equation
          rr=s1.c*k;
        end FlowReaction;
