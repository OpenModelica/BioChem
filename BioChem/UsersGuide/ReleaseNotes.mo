...
class ReleaseNotes
  ...
  annotation(
    Documentation(info = "<html><head></head><body><h2>History</h2><p>The first version of the library was created by Emma Larsdotter Nilsson at Linköping University. The current version of the library has been further developed by Erik Ulfhielm at Linköping University, and by MathCore Engineering AB.</p><ul><li>Main Author 2007-2009: MathCore Engineering AB</li><li>Main Author 2006: Erik Ulfhielm</li><li>Main Author 2004-2005: Emma Larsdotter Nilsson</li></ul><p><br></p><h2>Versions</h2><ul><li>Version 1.0.3 (2021-04-06)<ul><li>Conversion script to MSL 4.0.0</li></ul></li><li></li><li>Version 1.0.2 (2020-06-02)<ul><li>All major components are separated into *.mo files</li><li>MSL 3.2.3</li></ul></li><li>Version 1.0.1 (2013-04-18)<ul><li>Applied patch to latest version provided by MathCore Engineering AB.</li><li>Changed uses-annotation to MSL 3.2, encoding to ASCII+HTML entities, and started using modelica:// URLs for image sources (Martin Sjölund).</li></ul></li><li>Version 1.0 (2009-08-31)</li><li>Version 0.96 (2008-12-19)</li></ul></body></html>"));
end ReleaseNotes;
