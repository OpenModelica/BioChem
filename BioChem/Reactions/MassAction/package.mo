...
package MassAction "Mass-action kinetics reactions"
 ...
 <p><br /> <img src=\"modelica://BioChem/Resources/Images/MassAction.png\" alt=\"\" /></p>", revisions = ""), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10})), Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {10, 10})));
end MassAction;